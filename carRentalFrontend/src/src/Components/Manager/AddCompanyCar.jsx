...
function AddCompanyCar() {
    ...
    const [image, setImage] = useState("");   // file name or URL
    ...
    const AddNewCar = async () => {
        const result = await axios.post(`http://localhost:8080/api/car/add/${0}/${selectedBranchId}`,
            {
                'brand': brand,
                'model': model,
                'category': category,
            ...
            navigate("/managerdashboard/cars")
    }
